...
## An optimal B (batch-size for minibatch SGD is model-, dataset-, and
## hardware-dependent, and can be anywhere from 1 to maybe several
## hundreds. In the tutorial we set it to 20, but this choice is
## almost arbitrary (though harmless).
